...
namespace FilterPDF.Commands
{
    internal static class ObjectsOperators
    {
        ...
        private static void ShowHelp()
        {
            ...
            Console.WriteLine("tjpdf-cli inspect objects operators var --inputs a.pdf,b.pdf --obj N [--blocks] [--blocks-inline] [--ops-diff] [--line-mode] [--cleanup semantic|lossless|efficiency] [--full-text]");
            Console.WriteLine("tjpdf-cli inspect objects operators var --input file.pdf --obj N --self [--anchors] [--anchors-out <dir|file>]");
            Console.WriteLine("tjpdf-cli inspect objects operators fixed --inputs a.pdf,b.pdf --obj N [--ops-diff] [--line-mode] [--cleanup semantic|lossless|efficiency] [--full-text]");
            Console.WriteLine("tjpdf-cli inspect objects operators fixed --input file.pdf --obj N --self [--rules <yml> | --doc <nome>]");
            Console.WriteLine("tjpdf-cli inspect objects operators diff --inputs a.pdf,b.pdf --obj N [--ops-diff] [--line-mode] [--cleanup semantic|lossless|efficiency] [--full-text]");
